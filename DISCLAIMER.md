...
**Attribution requirement persists:** Use of the material is governed by the repository license (CC BY 4.0) and the attribution rules described in `README`. Any redistribution must also include this disclaimer.
